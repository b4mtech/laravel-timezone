...
use MedicPlus\LaravelTimezone\Listeners\Auth\UpdateUsersTimezone;
...
class LaravelTimezoneServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        AliasLoader::getInstance()->alias('Timezone', \MedicPlus\LaravelTimezone\Facades\Timezone::class);
